...
ActiveRecord::Schema.define(:version => 201312522848) do
  ...
  create_table :peopleUsers, :id => false do |t|
    t.references :people
    t.references :users
  end

  create_table :personPlaces do |t|
    t.integer :person_id
    t.references :places
  end
  ...
  create_table :schemaMigrations, :id => false do |t|
    t.string :version, :limit => 255, :null => false
  end

  create_table :sqliteSequence, :id => false do |t|
    t.integer :name
    t.integer :seq
  end
  ...
  create_table :yardLocations do |t|
    t.references :places
    t.references :yards
  end
