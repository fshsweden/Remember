# RailsAdmin config file. Generated on October 02, 2013 10:02
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Remember', 'Admin']
  ...
  #     configure :cc_number, :string 
  #     configure :cc_cvc, :string 
  #     configure :cc_exp_month, :string 
  #     configure :cc_exp_year, :string 
  #     configure :cc_name, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :gifts, :has_many_association 
